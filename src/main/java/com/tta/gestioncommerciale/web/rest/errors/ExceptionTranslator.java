package com.tta.gestioncommerciale.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.tta.gestioncommerciale.service.EmailAlreadyUsedException ||
            ex instanceof com.tta.gestioncommerciale.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.tta.gestioncommerciale.service.InvalidPasswordException
